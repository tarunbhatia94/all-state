...
%>
 ...
 <div class="ls-row LayoutBody" id="bodyContainer">
       <!--Body content here-->
    </div>
                          ...
                          <div class="quoteDrop">
                            <div class="quoteSelect">
                              ...
                              <dl>
                                ...
                                <dd><a href="insurance/all-insurance-productsc20c.html?zip=&amp;product=Mr&amp;intcid=/home/home.aspx|quote_box|Mr" onclick="return true;" class="quoteIcon moreIcon" style="background-image:url(resources/Images/MoreIcon.png);background-repeat:no-repeat;padding-left:35px;" name="&lpos=Drawer">More</a></dd>
                              </dl>
                    ...
                    $(document).keyup(function(e) {
                      ...
                      <div class="column addtl">
                        <div class="column support">
                          ...
                          <a href="tel:1-800-255-7828" class="phone">1-800-ALLSTATE <br />
                    ...
                    <div class="FooterInner">
                      <div class="lbnColumn" style="width:31%">
                        <ul class="FooterImage TextCenter">
                          <li class="PositioningDiv"><a class="AllstateLogo" href="index.html" target="_top" name="&amp;lpos=LogoBottomNavigation"><img src="images/logo_footer.png" alt="Allstate logo. "/></a></li>
                        </ul>
                        <ul class="FooterGray FooterSocial TextLeft">
                          <li class="lbnRowTitle"><a href="social-networks.html" Target="_top">Connect With Us</a></li>
                        ...
                        <ul>
                          <li class="FooterGray TextCenter">
                            <ul class="PositioningDiv TextLeft">
                              <li class="AboutAllstateHeader"><a href="about.html" target="_top" name="&amp;lpos=LogoBottomNavigation">Company</a></li>
                              ...
                              <li class="AdditionalLink"><a onMouseOut="LogoBottomNavigationColorSwitch(this,'');" onMouseOver="LogoBottomNavigationColorSwitch(this,'');" style="color:" href="careers.html" target="_top" name="&amp;lpos=LogoBottomNavigation">Careers</a></li>
                              <li class="AdditionalLink"><a onMouseOut="LogoBottomNavigationColorSwitch(this,'');" onMouseOver="LogoBottomNavigationColorSwitch(this,'');" style="color:" href="support/overview.html" target="_top" name="&amp;lpos=LogoBottomNavigation">Customer Support</a></li>
                              <li class="AdditionalLink"><a onMouseOut="LogoBottomNavigationColorSwitch(this,'');" onMouseOver="LogoBottomNavigationColorSwitch(this,'');" style="color:" href="contactus.html" target="_blank" name="&amp;lpos=LogoBottomNavigation">Contact Us</a></li>
                            </ul>
                          </li>
                        </ul>
                      ...
                      <div class="lbnColumn" style="width:21%">
                        <ul>
                          <li class="FooterGray TextCenter">
                            <ul class="PositioningDiv TextLeft">
                              <li class="AboutAllstateHeader"><a href="site-map.html" target="_top" name="&amp;lpos=LogoBottomNavigation">Quick Links</a></li>
                              <li class="AdditionalLink"><a onMouseOut="LogoBottomNavigationColorSwitch(this,'');" onMouseOver="LogoBottomNavigationColorSwitch(this,'');" style="color:" href="auto-insurance.html" target="_top" name="&amp;lpos=LogoBottomNavigation">Auto Insurance</a></li>
                              <li class="AdditionalLink"><a onMouseOut="LogoBottomNavigationColorSwitch(this,'');" onMouseOver="LogoBottomNavigationColorSwitch(this,'');" style="color:" href="home-insurance.html" target="_top" name="&amp;lpos=LogoBottomNavigation">Home Insurance</a></li>
                              <li class="AdditionalLink"><a onMouseOut="LogoBottomNavigationColorSwitch(this,'');" onMouseOver="LogoBottomNavigationColorSwitch(this,'');" style="color:" href="claims.html" target="_top" name="&amp;lpos=LogoBottomNavigation">Claims</a></li>
                ...
                <div class="Footer" style="padding-top:0px; padding-bottom:0px;">
                  <div class="FooterOuter">
                    <ul class="FooterFirstRow">
                      <li><a href="site-map.html" target="_top" name="&amp;lpos=Footer">SITE MAP</a></li>
                      <li><a href="about/terms.html" target="_top" name="&amp;lpos=Footer">TERMS OF USE</a></li>
                      <li><a href="about/privacy-statement.html" target="_top" name="&amp;lpos=Footer">PRIVACY &amp; SECURITY</a></li>
                      <li><a href="about/privacy-statement.html" target="_top" name="&amp;lpos=Footer">NY Domestic Violence Notice</a></li>
                      <li><a href="about/name-location.html" target="_top" name="&amp;lpos=Footer">UNDERWRITING COMPANIES</a></li>
